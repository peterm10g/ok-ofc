...
@Service("meipiCustomerSapHandler")
public class MeipiCustomerSapHandler extends AbstractMeipiCustomerService {
    ...
    protected String commitMeipiCustomer(MeipiCustomer customer) throws BusinessException {
        ...
        try {
            ...
            if (meipiCustomerCode == null) {
                ret = this.wumartSapServiceProxy.addMeipiCustomer(user);
            } else {
                ret = this.wumartSapServiceProxy.modMeipiCustomer(user, meipiCustomerCode);
            }
