...
public interface ZWSMEIPICUSMAINTAINN {
    ...
    @RequestWrapper(localName = "ZmdMeipiCustomerMaintain", targetNamespace = "urn:sap-com:document:sap:soap:functions:mc-style", className = "com.wumart.sap2.meipi.cus.maintain.ZmdMeipiCustomerMaintain")
    @ResponseWrapper(localName = "ZmdMeipiCustomerMaintainResponse", targetNamespace = "urn:sap-com:document:sap:soap:functions:mc-style", className = "com.wumart.sap2.meipi.cus.maintain.ZmdMeipiCustomerMaintainResponse")
