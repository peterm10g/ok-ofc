...
public interface ZMPOBDSTATUSSELECT {
     ...
     * @param itHEAD
     * @return
     *     returns com.wumart.sap1.obdstatus.select.TABLEOFBAPIRET2
     */
    ...
    @RequestWrapper(localName = "ZMP_OBDSTATUS_SELECT", targetNamespace = "urn:sap-com:document:sap:rfc:functions", className = "com.wumart.sap1.obdstatus.select.ZMPOBDSTATUSSELECT_Type")
    @ResponseWrapper(localName = "ZMP_OBDSTATUS_SELECTResponse", targetNamespace = "urn:sap-com:document:sap:rfc:functions", className = "com.wumart.sap1.obdstatus.select.ZMPOBDSTATUSSELECTResponse")
