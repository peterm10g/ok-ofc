 ...
 *         &lt;element name="Sopartners" type="{urn:sap-com:document:sap:soap:functions:mc-style}TableOfZbapiR2Createsopart"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ZBapiMeipiCreatesoResponse")
public class ZBapiMeipiCreatesoResponse {
    ...
    @XmlElement(name = "Sopartners", required = true)
