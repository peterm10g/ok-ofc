 ...
 */
public class CreateLshSoReqHead {
    ...
    private List<CreateLshSoReqDetail> detailList;
    ...
    public List<CreateLshSoReqDetail> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<CreateLshSoReqDetail> detailList) {
